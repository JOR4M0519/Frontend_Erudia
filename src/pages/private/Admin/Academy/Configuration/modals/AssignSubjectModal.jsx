...
import { X, Check, Book, Calendar } from "lucide-react";
import { motion } from "framer-motion";
import configurationService from "../configurationService";

const AssignSubjectModal = ({ isOpen, onClose, group, onSave }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Cargar materias con profesores
      ...
      setPeriods(periodsData.filter(period => period.status === "A"));
  ...
  const handleSubmit = async (e) => {
    ...
    if (!selectedSubjectProfessor || !selectedPeriod) {
    ...
    try {
      ...
      const subjectProfessor = subjectProfessors.find(sp => sp.id === parseInt(selectedSubjectProfessor));
