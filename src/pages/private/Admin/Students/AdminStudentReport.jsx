...
import { ChevronLeft, FileText, School, User, Calendar } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { motion } from "framer-motion";
import {AcademicLevelTab,AbsencesTab,RepeatingTab,NewStudentsTab} from "./Reports";
        ...
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex items-center">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm text-gray-500">Información detallada sobre los estudiantes del colegio</p>
            </div>
            {/* <div className="flex items-center">
      ...
      <section className="max-w-7xl mx-auto mt-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <div className="p-6">
            ...
            >
              {activeTab === "nivel" && <AcademicLevelTab year={currentYear} />}
              {activeTab === "ausencias" && <AbsencesTab year={currentYear} />}
              {activeTab === "repitentes" && <RepeatingTab year={currentYear} />}
              {activeTab === "nuevos" && <NewStudentsTab year={currentYear} />}
            </motion.div>
          </div>
        </div>
      </section>
