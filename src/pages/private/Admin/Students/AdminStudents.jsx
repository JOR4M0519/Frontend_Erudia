...
import { ClipboardList, RefreshCcw, Users } from "lucide-react";
...
const AdminStudents = () => {
  ...
  const cards = [
    {
      title: "Reportes",
      description: "Visualiza informes detallados sobre estudiantes y su desempeño",
      icon: <ClipboardList className="h-12 w-12 text-yellow-600" />,
      path: AdminRoutes.STUDENTS_REPORTS,
      bgColor: "bg-gradient-to-br from-yellow-50 to-yellow-100"
    },
    {
      title: "Procesos",
      description: "Gestiona procesos administrativos relacionados con los estudiantes",
      icon: <RefreshCcw className="h-12 w-12 text-blue-600" />,
      path: AdminRoutes.STUDENTS_PROCESSES,
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Administra toda la información relacionada con los estudiantes</p>
          </div>
