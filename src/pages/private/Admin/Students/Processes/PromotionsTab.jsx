    ...
    <div>
      <div className="mb-6 flex items-center">
        ...
        <label htmlFor="selectActiveStudents" className="ml-2 block text-sm text-gray-700 font-medium">
          Seleccionar estudiantes activos
        </label>
      </div>
      ...
      <div className="mt-8 flex justify-center">
        <button className="px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg transition-colors">
          Promoveer a todos los estudiantes activos
        </button>
      </div>
    </div>
  );
...
const ClassSection = ({ className, students, currentYear, nextYear }) => {
          ...
          <div className="flex justify-between border-b pb-2 mb-2">
            ...
            <div className="w-2/3">
              <div className="flex items-center justify-end">
                <span className="mr-2">Promover de</span>
